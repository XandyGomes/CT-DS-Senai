programa
{
	...
	funcao inicio()
	{
		...
		se(volta1 <= volta2 e volta1 < volta3 ou volta1 < volta2 e volta1 <= volta3){
			escreva("A volta 1 foi a mais rápida")
		}senao se(volta2 <= volta1 e volta2 < volta3 ou volta2 < volta1 e volta2 <= volta3){
			escreva("A volta 2 foi a mais rápida")
		}senao se (volta3 <= volta1 e volta3 < volta2 ou volta3 < volta1 e volta3 <= volta2){
